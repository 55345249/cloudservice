package com.primeton.cloud.util;
...
@EnableWebMvc
@ComponentScan(basePackages = {"com.primeton.cloud"})  //需要扫描的包路径
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.primeton.cloud.controller"))
